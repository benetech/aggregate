 ...
 *
 */
public class OdkTablesViewTableFileInfo extends SortableFlexTable {
  ...
  public void updateData(TableEntryClient table) {
    ...
    if (AggregateUI.getUI().getUserInfo().getGrantedAuthorities()
      ...
      SecureGWT.getServerDataService().getTableFileInfoContents(table.getTableId(), getSortColumn(), isAscending(), getDataCallback);
    }
  }
